          ...
          <div className="flex-1 flex justify-end items-center gap-3 min-w-0">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 text-text-secondary hover:text-text-primary hover:bg-bg-elevated px-3 py-2 rounded-lg transition-all duration-300 shrink-0"
                id="btn-profile"
              >
                ...
                {user && (
                  <div className="hidden lg:flex flex-col items-start">
                    <span className="text-xs text-text-primary font-semibold">{user.nombre}</span>
                    <span className="text-xs text-text-muted">{user.rol}</span>
                  </div>
                )}
              </button>
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-bg-elevated border border-border rounded-lg shadow-lg z-50">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-4 py-2.5 text-sm text-danger hover:bg-bg-hover transition-colors"
                  >
