        ...
        <>
          <div className="flex justify-between items-start">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center border border-border ${
              ...
              <Icon className={`w-6 h-6 ${variant === 'accent' ? 'text-primary' : 'text-secondary'}`} />
            </div>
            {badge && (
          ...
          <div>
            ...
            {stat && (
              <div className="glass-light rounded-lg p-3 flex justify-between items-center">
                <span className="text-[0.65rem] uppercase text-text-muted tracking-wider">{stat.label}</span>
                ...
                <div className="w-full bg-bg-hover rounded-full h-1.5 mb-2 overflow-hidden">
                  <div
                    ...
                    style={{
                      ...
                      background: 'linear-gradient(90deg, var(--color-secondary-dim), var(--color-secondary))',
                    }}
                  />
                </div>
