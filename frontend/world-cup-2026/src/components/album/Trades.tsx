...
export function Trades({ laminas, onAccept }: TradesProps) {
  ...
  const handleAccept = (offer: TradeOffer) => {
    ...
    setLog((prev) => [
      `✅ Intercambiaste ${offer.theyWant.nombreJugador} por ${offer.theyOffer.nombreJugador} con ${offer.botName}`,
      ...prev.slice(0, 9),
    ]);
  };
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontSize: 13,
            fontWeight: 600,
            cursor: repeated.length > 0 ? 'pointer' : 'not-allowed',
            fontFamily: 'Inter,sans-serif',
          }}
        >
          🔄 Buscar ofertas
            ...
            return (
              ...
              >
                ...
                <div style={{ minWidth: 80, textAlign: 'center' }}>
                  ...
                  <p
                    style={{
                      color: urgent ? '#f87171' : 'rgba(255,255,255,0.4)',
                      fontSize: 10,
                      margin: 0,
                      fontFamily: 'Inter,sans-serif',
                    }}
                ...
                >
                  ...
                  />
                  <span
                    style={{ fontSize: 10, color: offerRc.color, fontFamily: 'Inter,sans-serif' }}
                  >
                    {offerRc.label}
                  </span>
                </div>
                ...
                >
                  ...
                  />
                  <span
                    style={{ fontSize: 10, color: wantRc.color, fontFamily: 'Inter,sans-serif' }}
                  >
                    {wantRc.label}
                  </span>
                </div>
                ...
                {/* Buttons */}
                <div
                  style={{ display: 'flex', flexDirection: 'column', gap: 8, marginLeft: 'auto' }}
                >
                  <button
