...
function PitchView({ w, h }: { w: number; h: number }) {
  ...
  return (
    <div style={{
      width: w, height: h,
      background: 'repeating-linear-gradient(90deg,#2a6e2a 0px,#2a6e2a 16px,#317431 16px,#317431 32px)',
      borderRadius: 4,
      position: 'relative',
      overflow: 'hidden',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: '3px 5px', background: 'rgba(0,0,0,0.38)',
      }}>
        <span style={{ fontSize: 10, lineHeight: 1 }}>🏟️</span>
        <span style={{ fontSize: 7, color: '#c084fc', fontWeight: 800, fontFamily: 'Oswald, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{
          fontSize: nameSize, fontWeight: 700, color: '#fff',
        ...
        {size !== 'xs' && (
          <div style={{ fontSize: 7, color: '#c084fc', fontFamily: 'Inter, sans-serif', marginTop: 1 }}>
            {stadium.ciudad}
          </div>
        )}
      </div>
