  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{
          fontSize: dim.sub - 2, color: rc.color, fontWeight: 800,
      ...
      <div style={{
        ...
        <span style={{
          ...
          fontSize: dim.dorsal,
          color: team.secondary, opacity: 0.1,
        ...
        {size !== 'xs' ? (
          ...
          <span style={{ position: 'relative', zIndex: 1, fontSize: 22, opacity: 0.5, lineHeight: 1 }}>⚽</span>
        )}
      </div>
      ...
      <div style={{
        ...
        <div style={{
          fontSize: dim.name, fontWeight: 700, color: '#fff',
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: dim.sub - 1, color: team.secondary, fontWeight: 600, fontFamily: 'Inter, sans-serif', opacity: 0.9 }}>
            {team.shortName}
          </span>
      ...
      {rz === 'LEGENDARIO' && (
        <div style={{
          ...
          background: 'linear-gradient(135deg,transparent 40%,rgba(253,230,138,0.08) 60%,transparent 80%)',
